...
import MaterialDatatableFilter from "../src/MaterialDatatableFilter";

describe("<MaterialDatatableFilter />", function() {
  let data;
  let columns;
  let filterData;
  ...
  it("should data table filter view with checkboxes if filterType = 'checkbox'", () => {
    ...
    const shallowWrapper = mount(
      <MaterialDatatableFilter columns={columns} filterData={filterData} filterList={filterList} options={options} />,
    );
